          ...
          html: `
            ...
            <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
              ...
              <div style="background: #f8f9fa; border-radius: 12px; padding: 30px; margin-bottom: 20px;">
                ...
                <p><strong>Location Risk Detection:</strong> For ALL check-ins, whether your loved one is checking in at a meeting, responding to a location request, or checking in anywhere else, FamilyBridge automatically checks for flagged nearby locations like bars, liquor stores, THC dispensaries, and adult entertainment venues. If something concerning is detected, you'll be alerted. This works for every type of check-in, not just recovery meetings.</p>
