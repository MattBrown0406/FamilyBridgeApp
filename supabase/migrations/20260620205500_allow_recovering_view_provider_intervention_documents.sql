-- Allow family members, including the recovering individual, to view provider-uploaded
-- intervention letters assigned to their family in the family dashboard Documents tab.
